...
const testimonials = [
    ...
    { name: "Arun Babu", role: "NEET 2025 · Government MBBS", text: "The discipline system at ARK was different from anywhere else I had studied. Every test was tracked, every weak area was remediated. The HRC concept mastery framework helped me improve steadily and secure a Government MBBS seat.", rating: 5, type: "Student" },
    ...
    { name: "Divya R.", role: "NEET 2025 · State Quota MBBS", text: "ARK's NCERT-first approach made all the difference. While others were confused with multiple reference books, I mastered NCERT completely. A 602 score and a state-quota medical seat — all thanks to ARK.", rating: 5, type: "Student" },
